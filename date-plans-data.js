...
window.DATE_PLANNER_DATA = {
  ...
  scenarioLibrary: [
    ...
    },
    {
      ...
      coreAdvice: "落ち着いて話したい日は、イベントの強さより『一緒にいてしんどくない』ことが重要。近場・短時間・静けさを味方にして、関係の温度を戻す設計にする。",
      aiRecommendations: [
    ...
    },
    {
      ...
      coreAdvice: "気持ちを整えたい日は、楽しさより『安心して同じ場所にいられること』が大切。短時間・近場・退路ありの設計が基本になる。",
      aiRecommendations: [
    ...
    },
    {
      ...
      ourRecommendations: [
        "相手が大切にされていると感じやすい『ほっとする時間』を主役にする",
